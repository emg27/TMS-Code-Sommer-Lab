% Your struct 's' must be loaded onto the workspace.

% First convert .csv to .mat file
% If using the GUI to import your .csv file to MATLAB, make sure to
% import as Column Vectors. Before importing, make sure to convert your
% 'Date' column from Datetime format to TEXT format.
% Also tried converting all columns to TEXT format.
[File,PathName] = uigetfile('*.mat');%uiputfile('*.mat')
load([PathName File])

% Once you've created your .mat file, you may need to convert variables
% from double to cell format.
% BlockNumber = num2cell(BlockNumber);
