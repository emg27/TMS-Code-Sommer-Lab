...
%%plot the neuron response, after vs before. Updated
...
clear
[filename, pathname]=uigetfile('*.mat','Upload the heatplot data')%'oxford_2014.mat';
base_save=load([pathname filename]);
close all
%set the parameter
